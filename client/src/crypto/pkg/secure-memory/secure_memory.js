/* @ts-self-types="./secure_memory.d.ts" */
 ...
 * @returns {number}
 */
export function secure_alloc(len) {
    const ret = wasm.secure_alloc(len);
    return ret >>> 0;
}
 ...
 * @returns {Uint8Array}
 */
export function secure_read(ptr, len) {
    const ret = wasm.secure_read(ptr, len);
 ...
 * @returns {boolean}
 */
export function secure_write(ptr, len, src) {
    const ptr0 = passArray8ToWasm0(src, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.secure_write(ptr, len, ptr0, len0);
    return ret !== 0;
}
 ...
 * @param {number} len
 */
export function secure_zero_and_free(ptr, len) {
    wasm.secure_zero_and_free(ptr, len);
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('secure_memory_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
