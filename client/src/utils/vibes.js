...
export const VIBES = {
    default: {
        ...
        sidebarClass: 'bg-white/95 dark:bg-gray-950/80',
        panelClass: 'bg-white/95 dark:bg-gray-950/80',
    ...
    party: {
        ...
        sidebarClass: 'bg-indigo-100/90 dark:bg-indigo-950/80',
        panelClass: 'bg-indigo-100/90 dark:bg-indigo-950/80',
        inputClass: 'bg-white/90 dark:bg-indigo-900/80 border-indigo-200/50 dark:border-indigo-500/30 backdrop-blur-xl shadow-inner',
    ...
    chill: {
        ...
        sidebarClass: 'bg-teal-100/90 dark:bg-teal-950/80',
        panelClass: 'bg-teal-100/90 dark:bg-teal-950/80',
        inputClass: 'bg-white/90 dark:bg-teal-900/80 border-teal-200/50 dark:border-teal-500/30 backdrop-blur-xl shadow-inner',
    ...
    focus: {
        ...
        sidebarClass: 'bg-amber-100/90 dark:bg-amber-950/80',
        panelClass: 'bg-amber-100/90 dark:bg-amber-950/80',
        inputClass: 'bg-white/90 dark:bg-orange-900/80 border-orange-200/50 dark:border-orange-500/30 backdrop-blur-xl shadow-inner',
