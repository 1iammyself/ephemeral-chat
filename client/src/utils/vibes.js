...
export const VIBES = {
    ...
    campfire: {
        ...
        name: 'Solace',
        emoji: '🏕️',
        bgClass: 'bg-gradient-to-br from-rose-400 via-rose-300 to-rose-400 dark:bg-[#1a0f0f]',
    ...
    jazz: {
        ...
        name: 'Noire',
        emoji: '🎺',
        bgClass: 'bg-gradient-to-br from-zinc-500 via-zinc-400 to-zinc-500 dark:from-[#0c0c14] dark:via-[#121220] dark:to-black',
        ...
        sidebarClass: 'bg-transparent dark:bg-[#0c0c14]/60 backdrop-blur-xl',
        panelClass: 'bg-transparent dark:bg-[#0c0c14]/50 dark:backdrop-blur-2xl dark:border-b dark:border-yellow-500/5',
