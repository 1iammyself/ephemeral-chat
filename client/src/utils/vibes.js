...
export const VIBES = {
    ...
    party: {
        ...
        sidebarClass: 'bg-indigo-100/95 dark:bg-gray-900/95',
        panelClass: 'bg-indigo-100/95 dark:bg-gray-900/95',
    ...
    chill: {
        ...
        sidebarClass: 'bg-teal-100/95 dark:bg-gray-900/95',
        panelClass: 'bg-teal-100/95 dark:bg-gray-900/95',
    ...
    focus: {
        ...
        sidebarClass: 'bg-orange-100/95 dark:bg-gray-900/95',
        panelClass: 'bg-orange-100/95 dark:bg-gray-900/95',
