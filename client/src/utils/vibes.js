...
export const VIBES = {
    default: {
        ...
        inputClass: 'bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700',
    ...
    party: {
        ...
        inputClass: 'bg-indigo-50/50 dark:bg-indigo-900/30 border-indigo-200 dark:border-indigo-800',
    ...
    chill: {
        ...
        inputClass: 'bg-teal-50/50 dark:bg-teal-900/30 border-teal-200 dark:border-teal-800',
    ...
    focus: {
        ...
        inputClass: 'bg-orange-50/50 dark:bg-orange-900/30 border-orange-200 dark:border-orange-800',
