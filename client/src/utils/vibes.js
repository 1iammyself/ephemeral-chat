...
export const VIBES = {
    default: {
        ...
        name: 'Default',
        emoji: '💬',
        bgClass: 'bg-blue-100/60 dark:bg-black',
        messageClass: 'bg-primary-600 dark:bg-primary-700 text-white rounded-tr-none',
        sidebarClass: 'bg-blue-200/80 dark:bg-gray-950/40',
    ...
    party: {
        ...
        name: 'Party',
        emoji: '🎉',
        bgClass: 'bg-gradient-to-br from-indigo-300 via-purple-400 to-pink-300 dark:from-indigo-950 dark:via-purple-950 dark:to-pink-900',
        ...
        sidebarClass: 'bg-purple-300/60 dark:bg-indigo-950/20',
    ...
    chill: {
        ...
        name: 'Chill',
        emoji: '🌊',
        bgClass: 'bg-gradient-to-br from-teal-300 via-cyan-400 to-emerald-300 dark:from-teal-950 dark:via-cyan-950 dark:to-emerald-900',
        messageClass: 'bg-teal-600 dark:bg-teal-700 text-white rounded-tr-none',
        sidebarClass: 'bg-teal-300/60 dark:bg-teal-950/20',
    ...
    focus: {
        ...
        name: 'Focus',
        emoji: '🎯',
        bgClass: 'bg-gradient-to-br from-amber-300 via-orange-400 to-yellow-300 dark:from-amber-950 dark:via-orange-950 dark:to-yellow-950',
        messageClass: 'bg-orange-600 dark:bg-orange-700 text-white rounded-tr-none',
        sidebarClass: 'bg-amber-300/60 dark:bg-amber-950/20',
    ...
    campfire: {
        ...
        name: 'Solace',
        emoji: '🏕️',
        bgClass: 'bg-gradient-to-br from-rose-300 via-rose-400 to-rose-300 dark:from-[#1a0f0f] dark:via-[#2d1b10] dark:to-black',
        ...
        sidebarClass: 'bg-rose-300/60 dark:bg-rose-950/20 backdrop-blur-xl',
        panelClass: 'bg-transparent dark:bg-rose-950/30 dark:backdrop-blur-2xl dark:border-b dark:border-rose-800/20',
        inputClass: 'bg-transparent dark:bg-rose-900/10 border-transparent dark:border-rose-900/30 backdrop-blur-3xl',
    ...
    ocean: {
        ...
        name: 'Abyss',
        emoji: '🌊',
        bgClass: 'bg-gradient-to-br from-sky-300 via-sky-400 to-sky-300 dark:from-[#051120] dark:via-[#0a1f33] dark:to-black',
        ...
        sidebarClass: 'bg-sky-300/60 dark:bg-sky-950/20 backdrop-blur-xl',
    ...
    forest: {
        ...
        name: 'Verdant',
        emoji: '🌳',
        bgClass: 'bg-gradient-to-br from-emerald-300 via-emerald-400 to-emerald-300 dark:from-[#0f1a10] dark:via-[#1a2e1d] dark:to-black',
        ...
        sidebarClass: 'bg-emerald-300/60 dark:bg-emerald-950/20 backdrop-blur-xl',
    ...
    cafe: {
        ...
        sidebarClass: 'bg-[#d7ccc8]/60 dark:bg-[#1b1512]/40 backdrop-blur-xl',
    ...
    jazz: {
        ...
        name: 'Noire',
        emoji: '🎺',
        bgClass: 'bg-gradient-to-br from-zinc-400 via-zinc-500 to-zinc-400 dark:from-[#0a0a0f] dark:via-[#16161a] dark:to-black',
        ...
        sidebarClass: 'bg-zinc-400/60 dark:bg-zinc-950/40 backdrop-blur-xl',
        panelClass: 'bg-transparent dark:bg-zinc-950/50 dark:backdrop-blur-2xl dark:border-b dark:border-white/5',
        inputClass: 'bg-transparent dark:bg-zinc-900/20 border-transparent dark:border-yellow-500/10 backdrop-blur-3xl',
