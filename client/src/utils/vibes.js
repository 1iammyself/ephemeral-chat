...
export const VIBES = {
    ...
    campfire: {
        ...
        name: 'Solace',
        emoji: '🏕️',
        bgClass: 'bg-gradient-to-br from-rose-100 via-rose-200 to-rose-100 dark:from-[#1a0f0f] dark:via-[#2d1b10] dark:to-black',
    ...
    ocean: {
        ...
        name: 'Abyss',
        emoji: '🌊',
        bgClass: 'bg-gradient-to-br from-sky-100 via-sky-200 to-sky-100 dark:from-[#051120] dark:via-[#0a1f33] dark:to-black',
    ...
    forest: {
        ...
        name: 'Verdant',
        emoji: '🌳',
        bgClass: 'bg-gradient-to-br from-emerald-100 via-emerald-200 to-emerald-100 dark:from-[#0f1a10] dark:via-[#1a2e1d] dark:to-black',
    ...
    cafe: {
        ...
        name: 'Moka',
        emoji: '☕',
        bgClass: 'bg-gradient-to-br from-[#d7ccc8] via-[#bcaaa4] to-[#d7ccc8] dark:from-[#1b1512] dark:via-[#2a1e19] dark:to-black',
    ...
    jazz: {
        ...
        name: 'Noire',
        emoji: '🎺',
        bgClass: 'bg-gradient-to-br from-zinc-200 via-zinc-300 to-zinc-200 dark:from-[#0a0a0f] dark:via-[#16161a] dark:to-black',
