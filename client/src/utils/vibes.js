...
export const VIBES = {
    ...
    campfire: {
        ...
        name: 'Solace',
        emoji: '🏕️',
        bgClass: 'bg-gradient-to-br from-rose-100 via-orange-100 to-amber-100 dark:from-[#1a0f0f] dark:via-[#2d1b10] dark:to-black',
    ...
    ocean: {
        ...
        name: 'Abyss',
        emoji: '🌊',
        bgClass: 'bg-gradient-to-br from-cyan-100 via-sky-100 to-blue-200 dark:from-[#051120] dark:via-[#0a1f33] dark:to-black',
    ...
    forest: {
        ...
        name: 'Verdant',
        emoji: '🌳',
        bgClass: 'bg-gradient-to-br from-lime-100 via-green-100 to-emerald-200 dark:from-[#0f1a10] dark:via-[#1a2e1d] dark:to-black',
    ...
    cafe: {
        ...
        name: 'Moka',
        emoji: '☕',
        bgClass: 'bg-gradient-to-br from-orange-100 via-yellow-100/50 to-gray-100 dark:from-[#20150a] dark:via-[#332517] dark:to-black',
        messageClass: 'bg-amber-800 dark:bg-amber-950/80 text-white rounded-tr-none border border-amber-800/20 shadow-lg shadow-amber-900/20',
        sidebarClass: 'bg-amber-100/20 dark:bg-amber-950/20 backdrop-blur-xl',
        panelClass: 'bg-amber-50/30 dark:bg-amber-950/40 backdrop-blur-2xl',
        inputClass: 'bg-white/40 dark:bg-amber-900/10 border-amber-200 dark:border-amber-950/40 shadow-inner focus:ring-2 focus:ring-amber-600/40 transition-all',
        accentClass: 'bg-amber-800 hover:bg-amber-900 text-white shadow-md shadow-amber-900/20',
        effectType: 'steam',
    ...
    jazz: {
        ...
        name: 'Noire',
        emoji: '🎺',
        bgClass: 'bg-gradient-to-br from-zinc-200 via-slate-300 to-gray-300 dark:from-[#0a0a0f] dark:via-[#16161a] dark:to-black',
