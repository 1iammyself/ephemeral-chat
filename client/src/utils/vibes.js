...
export const VIBES = {
    ...
    campfire: {
        ...
        name: 'Solace',
        emoji: '🏕️',
        bgClass: 'bg-gradient-to-br from-rose-400 via-rose-300 to-rose-400 dark:from-[#1a0f0f] dark:via-[#2d1b10] dark:to-black',
        ...
        sidebarClass: 'bg-transparent dark:bg-rose-950/20 backdrop-blur-xl',
    ...
    jazz: {
        ...
        name: 'Noire',
        emoji: '🎺',
        bgClass: 'bg-gradient-to-br from-zinc-500 via-zinc-400 to-zinc-500 dark:from-[#0a0a0f] dark:via-[#16161a] dark:to-black',
        ...
        sidebarClass: 'bg-transparent dark:bg-zinc-950/40 backdrop-blur-xl',
