...
export const VIBES = {
    default: {
        ...
        name: 'Default',
        emoji: '💬',
        bgClass: 'bg-blue-50 dark:bg-black',
        messageClass: 'bg-primary-600 dark:bg-primary-700 text-white rounded-tr-none',
        sidebarClass: 'bg-blue-100/60 dark:bg-gray-950/40 border-l border-blue-200/80 dark:border-white/5',
        panelClass: 'bg-blue-100/60 dark:bg-gray-950/40 border-b border-blue-200/80 dark:border-white/5',
        inputClass: 'bg-blue-100/50 dark:bg-white/5 border-blue-300/60 dark:border-white/10 backdrop-blur-3xl shadow-inner',
    ...
    party: {
        ...
        sidebarClass: 'bg-purple-200/50 dark:bg-indigo-950/20 border-l border-purple-300/60 dark:border-indigo-500/10',
        panelClass: 'bg-purple-200/50 dark:bg-indigo-950/20 border-b border-purple-300/60 dark:border-indigo-500/10',
        inputClass: 'bg-indigo-200/50 dark:bg-indigo-500/10 border-indigo-400/50 dark:border-indigo-500/20 backdrop-blur-3xl shadow-inner',
    ...
    chill: {
        ...
        sidebarClass: 'bg-teal-200/50 dark:bg-teal-950/20 border-l border-teal-300/60 dark:border-teal-500/10',
        panelClass: 'bg-teal-200/50 dark:bg-teal-950/20 border-b border-teal-300/60 dark:border-teal-500/10',
        inputClass: 'bg-teal-200/50 dark:bg-teal-500/10 border-teal-400/50 dark:border-teal-500/20 backdrop-blur-3xl shadow-inner',
    ...
    focus: {
        ...
        sidebarClass: 'bg-amber-200/50 dark:bg-amber-950/20 border-l border-amber-300/60 dark:border-amber-500/10',
        panelClass: 'bg-amber-200/50 dark:bg-amber-950/20 border-b border-amber-300/60 dark:border-amber-500/10',
        inputClass: 'bg-amber-200/50 dark:bg-orange-500/10 border-amber-400/50 dark:border-orange-500/20 backdrop-blur-3xl shadow-inner',
    ...
    campfire: {
        ...
        sidebarClass: 'bg-rose-200/50 dark:bg-rose-950/20 backdrop-blur-xl border-l border-rose-300/60 dark:border-rose-800/20',
        panelClass: 'bg-rose-200/50 dark:bg-rose-950/30 backdrop-blur-2xl border-b border-rose-300/60 dark:border-rose-800/20',
        inputClass: 'bg-rose-100/60 dark:bg-rose-900/10 border-rose-300/60 dark:border-rose-900/30 shadow-inner focus:ring-2 focus:ring-rose-500/40 transition-all',
    ...
    ocean: {
        ...
        sidebarClass: 'bg-sky-200/50 dark:bg-sky-950/20 backdrop-blur-xl border-l border-sky-300/60 dark:border-sky-800/20',
        panelClass: 'bg-sky-200/50 dark:bg-sky-950/30 backdrop-blur-2xl border-b border-sky-300/60 dark:border-sky-800/20',
        inputClass: 'bg-sky-100/60 dark:bg-sky-900/10 border-sky-300/60 dark:border-sky-900/30 shadow-inner focus:ring-2 focus:ring-sky-500/40 transition-all',
    ...
    forest: {
        ...
        sidebarClass: 'bg-emerald-200/50 dark:bg-emerald-950/20 backdrop-blur-xl border-l border-emerald-300/60 dark:border-emerald-800/20',
        panelClass: 'bg-emerald-200/50 dark:bg-emerald-950/30 backdrop-blur-2xl border-b border-emerald-300/60 dark:border-emerald-800/20',
        inputClass: 'bg-emerald-100/60 dark:bg-emerald-900/10 border-emerald-300/60 dark:border-emerald-900/30 shadow-inner focus:ring-2 focus:ring-emerald-500/40 transition-all',
    ...
    cafe: {
        ...
        sidebarClass: 'bg-[#d7ccc8]/50 dark:bg-[#1b1512]/40 backdrop-blur-xl border-l border-[#a1887f]/40 dark:border-[#3e2723]/30',
        panelClass: 'bg-[#d7ccc8]/50 dark:bg-[#1b1512]/50 backdrop-blur-2xl border-b border-[#a1887f]/40 dark:border-[#3e2723]/30',
        inputClass: 'bg-[#d7ccc8]/60 dark:bg-[#3e2723]/20 border-[#a1887f]/50 dark:border-[#3e2723]/40 shadow-inner focus:ring-2 focus:ring-[#5d4037]/40 transition-all',
    ...
    jazz: {
        ...
        sidebarClass: 'bg-zinc-300/50 dark:bg-zinc-950/40 backdrop-blur-xl border-l border-zinc-400/50 dark:border-yellow-500/5',
        panelClass: 'bg-zinc-300/50 dark:bg-zinc-950/50 backdrop-blur-2xl border-b border-zinc-400/50 dark:border-white/5',
        inputClass: 'bg-zinc-300/50 dark:bg-zinc-900/20 border-zinc-400/50 dark:border-yellow-500/10 shadow-inner focus:ring-2 focus:ring-yellow-500/20 transition-all',
