...
export const VIBES = {
    default: {
        ...
        sidebarClass: 'bg-white/90 dark:bg-gray-950/80',
        panelClass: 'bg-white/90 dark:bg-gray-950/80',
        inputClass: 'bg-gray-100/80 dark:bg-gray-900/80 border-gray-200 dark:border-white/10 backdrop-blur-xl shadow-inner',
    ...
    party: {
        ...
        sidebarClass: 'bg-indigo-50/90 dark:bg-indigo-950/80',
        panelClass: 'bg-indigo-50/90 dark:bg-indigo-950/80',
        inputClass: 'bg-indigo-50/90 dark:bg-indigo-900/80 border-indigo-200/50 dark:border-indigo-500/30 backdrop-blur-xl shadow-inner',
    ...
    chill: {
        ...
        sidebarClass: 'bg-teal-50/90 dark:bg-teal-950/80',
        panelClass: 'bg-teal-50/90 dark:bg-teal-950/80',
        inputClass: 'bg-teal-50/90 dark:bg-teal-900/80 border-teal-200/50 dark:border-teal-500/30 backdrop-blur-xl shadow-inner',
    ...
    focus: {
        ...
        sidebarClass: 'bg-amber-50/90 dark:bg-amber-950/80',
        panelClass: 'bg-amber-50/90 dark:bg-amber-950/80',
        inputClass: 'bg-orange-50/90 dark:bg-orange-900/80 border-orange-200/50 dark:border-orange-500/30 backdrop-blur-xl shadow-inner',
