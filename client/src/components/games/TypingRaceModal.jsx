...
const TypingRaceModal = ({ isOpen, onClose, message, currentUser, onTypingRaceJoin, onTypingRaceStart, onTypingRaceProgress, onTypingRaceFinish, onRematch, onShareResult, roomVibe }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 animate-in fade-in duration-300">
      ...
      {/* Modal Container */}
  <div style={windowStyle} className={`relative w-full ${isMaximized ? 'max-w-none rounded-xl' : 'max-w-3xl rounded-2xl sm:rounded-3xl'} bg-gray-50 dark:bg-gray-950 shadow-2xl overflow-hidden border border-gray-300 dark:border-white/10 flex flex-col max-h-[95vh] sm:max-h-[90vh] animate-in zoom-in-95 duration-300`}>
