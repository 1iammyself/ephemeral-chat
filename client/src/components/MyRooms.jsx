...
const MyRooms = () => {
    ...
    return (
        <div className="min-h-screen h-screen overflow-y-auto bg-gradient-to-br from-gray-50 via-white to-gray-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
            <div className="max-w-4xl mx-auto pt-14 pb-4 px-4 sm:p-6">
                {/* Header */}
                <div className="mb-6">
                    <button
                        onClick={() => navigate('/')}
