...
export default function StegoModal({ isOpen, onClose, onSendStego, embedded = false, initialExtractImage = null }) {
  ...
  return (
    ...
    >
      <div className={embedded ? "w-full h-full flex flex-col overflow-hidden" : "w-full sm:w-[480px] bg-white dark:bg-gray-900 rounded-t-3xl sm:rounded-2xl shadow-2xl overflow-hidden animate-in slide-in-from-bottom-4 sm:zoom-in-95 duration-200"}>
