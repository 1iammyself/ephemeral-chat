                  ...
                  <div className="break-words w-fit max-w-full">
                    ...
                    {isImage ? (
                      ...
                      <ChessMessage
                        ...
                        roomVibe={roomVibe}
                      />
                    ) : message.messageType === 'game' && message.gameData?.gameType === 'ttt' ? (
                      <TicTacToeMessage
