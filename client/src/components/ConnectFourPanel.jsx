      ...
      {isP1 && status === 'waiting' && !gameData?.player2 && !isCpu && (
        pendingCpu ? (
          <div className="flex gap-2">
            ...
            <button onClick={() => setPendingCpu(false)} className="px-3 py-1.5 rounded-lg text-xs font-bold bg-gray-200 dark:bg-gray-700 text-gray-600 dark:text-gray-300">✕</button>
          </div>
        ) : (
