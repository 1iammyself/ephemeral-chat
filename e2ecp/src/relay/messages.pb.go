...
type PBIncomingMessage struct {
	...
	Recipients        []string               `protobuf:"bytes,23,rep,name=recipients,proto3" json:"recipients,omitempty"`                                        // Recipient IDs
...
func (x *PBIncomingMessage) GetRecipients() []string {
	if x != nil {
		return x.Recipients
	}
	return nil
...
func (x *PBOutgoingMessage) GetRecipients() []string {
	if x != nil {
		return x.Recipients
	}
	return nil
